...
//==============================================
function massage_therapist_theme_ready_actions() {
	"use strict";
...
//==============================================
function massage_therapist_theme_scroll_actions() {
	"use strict";
...
//==============================================
function massage_therapist_theme_resize_actions() {
	"use strict";
...
//=====================================================
function massage_therapist_theme_sc_init(cont) {
	"use strict";
...
//=====================================================
function massage_therapist_theme_init_post_formats() {
	"use strict";
	...
	if (MASSAGE_THERAPIST_STORAGE['button_hover'] && MASSAGE_THERAPIST_STORAGE['button_hover']!='default') {
		jQuery('button:not(.search_submit):not([class*="sc_button_hover_"]),\
				.sc_button:not(.sc_button_style_border):not([class*="sc_button_hover_"]),\
				.woocommerce .button:not([class*="sc_button_hover_"]),.woocommerce-page .button:not([class*="sc_button_hover_"]),\
				#buddypress a.button:not([class*="sc_button_hover_"])'
				).addClass('sc_button_hover_'+MASSAGE_THERAPIST_STORAGE['button_hover']);
		if (MASSAGE_THERAPIST_STORAGE['button_hover']!='arrow')
	...
	//if (MASSAGE_THERAPIST_STORAGE['input_hover'])
	//	jQuery('form:not([class*="cp_cff_"]):not([class*="sc_input_hover_"])').addClass('sc_input_hover_'+MASSAGE_THERAPIST_STORAGE['input_hover']);
...
//=====================================================
function massage_therapist_theme_googlemap_styles($styles) {
	"use strict";
